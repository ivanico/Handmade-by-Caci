...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer panel */}
      <div
        className={`fixed inset-y-0 right-0 z-50 w-full sm:max-w-sm bg-white shadow-xl flex flex-col transition-transform duration-300 ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-border shrink-0">
          <h2 className="font-heading text-lg text-gray-900">Your Cart</h2>
